...
// 2. Pick a track that matches each video's VIBE (see comments)
// 3. Download via snaptik.app or musicaldown.com
// 4. Rename to the exact filename below
// 5. Upload all 7 to public/music/ in GitHub repo
// 6. Commit → render workflow uses them automatically
// ─────────────────────────────────────────────
...
// ── UPGRADE: Progress Bar Component ──
const ProgressBar = () => {
...
export const VideoComposition = ({ videoId }) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#000000' }}>
      ...
      {/* Layer 2: Light dark overlay for text legibility */}
      <AbsoluteFill style={{ backgroundColor: 'rgba(0,0,0,0.15)', zIndex: 0 }} />

      {/* Layer 3: Vignette — dark edges, bright center */}
      <Vignette />
      ...
      {/* Layer 7: Progress bar — always on top */}
      <ProgressBar />
